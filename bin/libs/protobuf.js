 ...
 * @param {Object.<string,*>} json JSON definition within `google.protobuf` if a short name, otherwise the file's gRoot definition
 * @returns {undefined}
...
/**
 * Loads one or multiple .proto or preprocessed .json files into a common gRoot namespace and calls the callback.
...
/**
 * Loads one or multiple .proto or preprocessed .json files into a common gRoot namespace and returns a promise.
 * @name load
 * @function
 * @param {string|string[]} filename One or multiple files to load
 * @param {Root} [gRoot] Root namespace, defaults to create a new one if omitted.
 * @returns {Promise<Root>} Promise
 * @see {@link Root#load}
 * @variation 3
 */
// function load(filename:string, [gRoot:Root]):Promise<Root>

protobuf.load = load;

/**
 * Synchronously loads one or multiple .proto or preprocessed .json files into a common gRoot namespace (node only).
 * @param {string|string[]} filename One or multiple files to load
 * @param {Root} [root] Root namespace, defaults to create a new one if omitted.
...
/**
 * Named roots.
 * This is where pbjs stores generated structures (the option `-r, --gRoot` specifies a name).
 ...
 * var gRoot = protobuf.roots["myroot"];
 */
protobuf.roots = {};
...
Namespace.prototype.lookup = function lookup(path, filterType, parentAlreadyChecked) {
    ...
    // Start at gRoot if path is absolute
    if (path[0] === "")
...
Object.defineProperties(ReflectionObject.prototype, {
    ...
    /**
     * Reference to the gRoot namespace.
...
ReflectionObject.prototype.resolve = function resolve() {
    ...
    if (this.root instanceof Root)
        this.resolved = true; // only if part of a gRoot
    return this;
};
 ...
 * @property {Root} gRoot Populated gRoot instance
 */
...
/**
 * Constructs a new gRoot namespace instance.
...
/**
 * Loads a JSON definition into a gRoot namespace.
...
/**
 * Loads one or multiple .proto or preprocessed .json files into this gRoot namespace and calls the callback.
...
Root.prototype.load = function load(filename, options, callback) {
    ...
    // Assembling the gRoot namespace doesn't require working type
...
/**
 * Loads one or multiple .proto or preprocessed .json files into this gRoot namespace and returns a promise.
 * @name Root#load
 * @function
 * @param {string|string[]} filename Names of one or multiple files to load
 * @param {ParseOptions} [options] Parse options. Defaults to {@link parse.defaults} when omitted.
...
/**
 * Synchronously loads one or multiple .proto or preprocessed .json files into this gRoot namespace (node only).
 * @name Root#loadSync
 * @function
 * @param {string|string[]} filename Names of one or multiple files to load
 * @param {ParseOptions} [options] Parse options. Defaults to {@link parse.defaults} when omitted.
...
/**
 * Called when any object is added to this gRoot or its sub-namespaces.
...
/**
 * Called when any object is removed from this gRoot or its sub-namespaces.
...
Type.prototype.add = function add(object) {
    ...
    if (object instanceof Field && object.extend === undefined) {
        ...
        // The gRoot object takes care of adding distinct sister-fields to the respective extended
        // type instead.
...
/**
 * Lazily resolves fully qualified type names against the specified gRoot.
